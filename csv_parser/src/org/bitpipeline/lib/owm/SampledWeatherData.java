...
public class SampledWeatherData extends AbstractWeatherData {
	...
	public static class Main extends AbstractWeatherData.Main{
		...
		public Main (JSONObject json) {
			this.temp = SampledFValue.createSampledFValueIfExisting (json, JSON_TEMP);
			this.tempMin = SampledFValue.createSampledFValueIfExisting (json, JSON_TEMP_MIN);
			this.tempMax = SampledFValue.createSampledFValueIfExisting (json, JSON_TEMP_MAX);
			this.pressure = SampledFValue.createSampledFValueIfExisting (json, JSON_PRESSURE);
			this.humidity = SampledFValue.createSampledFValueIfExisting (json, JSON_HUMIDITY);
		}
	...
	public static class Wind extends AbstractWeatherData.Wind {
		...
		public Wind (JSONObject json) {
			this.speed = SampledFValue.createSampledFValueIfExisting (json, JSON_SPEED);
			this.deg = SampledIValue.createSampledIValueIfExisting (json, JSON_DEG);
			this.gust = SampledFValue.createSampledFValueIfExisting (json, JSON_GUST);
			this.varBeg = SampledIValue.createSampledIValueIfExisting (json, JSON_VAR_BEG);
			this.varEnd = SampledIValue.createSampledIValueIfExisting (json, JSON_VAR_END);
		}
	...
	public SampledWeatherData (JSONObject json) {
		...
		JSONObject jsonRain = json.optJSONObject (JSON_RAIN);
		this.rain = jsonRain != null ? new Precipitation (jsonRain) : null;

		JSONObject jsonSnow = json.optJSONObject (JSON_SNOW);
