...
% ax2 = subplot(2,1,2);
% 
% fig = scatter(ax2 ,X ,y2 ,'filled','d');
% title(strcat( 'Regression du réseau de neurones : ' , int2str(i) , ' itérations d entraînement') )
% saveas(fig, strcat( 'images_demo_regression\puissance_deux\image', int2str(i) , '.png' ) )
% close all

%savefig( strcat( 'image', int2str(i) ) )
...
pour_dl = strcat(pour_dl, ' ' , '"image', int2str(i) , '"')
